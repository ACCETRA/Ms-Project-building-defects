...
- CUBIT-InSeg currently has all 701 official test images but no test labels; Google Drive has not yet allowed the remaining train/validation and label archives. Do not inspect/tune on the official test images while waiting.
...
|---|---|---|---|
| CUBIT-InSeg | Use all 5,596 train and 699 validation images when image+label archives arrive | All 701 official test images/labels | Primary building-façade UAV domain |
...
The likely first training universe is approximately 20,000–25,000 selected source images/tiles before augmentation, depending on CODEBRIM and CUBIT availability. It is intentionally much smaller than the total downloaded corpus.
...
- CUBIT train/validation masks are available or the source is formally deferred;
